...
module Infeasi_Res_S2_scaleVector_Pipeline_scale_vector (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ap_idle,
        ap_ready,
        dualInfeasConstr_fifo_i_dout,
        dualInfeasConstr_fifo_i_num_data_valid,
        dualInfeasConstr_fifo_i_fifo_cap,
        dualInfeasConstr_fifo_i_empty_n,
        dualInfeasConstr_fifo_i_read,
        dualInfeasConstr_SVfifo_i_din,
        dualInfeasConstr_SVfifo_i_num_data_valid,
        dualInfeasConstr_SVfifo_i_fifo_cap,
        dualInfeasConstr_SVfifo_i_full_n,
        dualInfeasConstr_SVfifo_i_write,
        n,
        weight
);
...
output   ap_idle;
output   ap_ready;
input  [511:0] dualInfeasConstr_fifo_i_dout;
input  [2:0] dualInfeasConstr_fifo_i_num_data_valid;
input  [2:0] dualInfeasConstr_fifo_i_fifo_cap;
input   dualInfeasConstr_fifo_i_empty_n;
output   dualInfeasConstr_fifo_i_read;
output  [511:0] dualInfeasConstr_SVfifo_i_din;
input  [2:0] dualInfeasConstr_SVfifo_i_num_data_valid;
input  [2:0] dualInfeasConstr_SVfifo_i_fifo_cap;
input   dualInfeasConstr_SVfifo_i_full_n;
output   dualInfeasConstr_SVfifo_i_write;
input  [31:0] n;
input  [63:0] weight;
...
reg    dualInfeasConstr_SVfifo_i_blk_n;
reg    ap_block_pp0_stage0_11001;
wire   [63:0] bitcast_ln162_fu_257_p1;
wire   [63:0] bitcast_ln162_1_fu_261_p1;
wire   [63:0] bitcast_ln162_2_fu_265_p1;
wire   [63:0] bitcast_ln162_3_fu_269_p1;
wire   [63:0] bitcast_ln162_4_fu_273_p1;
wire   [63:0] bitcast_ln162_5_fu_277_p1;
wire   [63:0] bitcast_ln162_6_fu_281_p1;
wire   [63:0] bitcast_ln162_7_fu_285_p1;
reg   [30:0] i_fu_70;
wire   [30:0] add_ln160_fu_163_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
reg    dualInfeasConstr_fifo_i_read_local;
wire   [511:0] or_ln168_i_fu_377_p9;
reg    ap_block_pp0_stage0_01001;
reg    dualInfeasConstr_SVfifo_i_write_local;
...
wire   [63:0] trunc_ln162_s_fu_187_p4;
wire   [63:0] trunc_ln162_1_fu_197_p4;
wire   [63:0] trunc_ln162_2_fu_207_p4;
wire   [63:0] trunc_ln162_3_fu_217_p4;
wire   [63:0] trunc_ln162_4_fu_227_p4;
wire   [63:0] trunc_ln162_5_fu_237_p4;
wire   [63:0] trunc_ln162_6_fu_247_p4;
...
wire   [63:0] bitcast_ln168_7_fu_373_p1;
wire   [63:0] bitcast_ln168_6_fu_369_p1;
wire   [63:0] bitcast_ln168_5_fu_365_p1;
wire   [63:0] bitcast_ln168_4_fu_361_p1;
wire   [63:0] bitcast_ln168_3_fu_357_p1;
wire   [63:0] bitcast_ln168_2_fu_353_p1;
wire   [63:0] bitcast_ln168_1_fu_349_p1;
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U96(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_99_p0),
    .din1(grp_fu_99_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U97(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_103_p0),
    .din1(grp_fu_103_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U98(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_107_p0),
    .din1(grp_fu_107_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U99(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_111_p0),
    .din1(grp_fu_111_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U100(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_115_p0),
    .din1(grp_fu_115_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U101(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_119_p0),
    .din1(grp_fu_119_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U102(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_123_p0),
    .din1(grp_fu_123_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U103(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_127_p0),
    .din1(grp_fu_127_p1),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter6 == 1'b1))) begin
        dualInfeasConstr_SVfifo_i_blk_n = dualInfeasConstr_SVfifo_i_full_n;
    end else begin
        dualInfeasConstr_SVfifo_i_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1))) begin
        dualInfeasConstr_SVfifo_i_write_local = 1'b1;
    end else begin
        dualInfeasConstr_SVfifo_i_write_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dualInfeasConstr_fifo_i_blk_n = dualInfeasConstr_fifo_i_empty_n;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dualInfeasConstr_fifo_i_read_local = 1'b1;
    end else begin
        dualInfeasConstr_fifo_i_read_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (dualInfeasConstr_fifo_i_empty_n == 1'b0);
end

always @ (*) begin
    ap_block_state7_pp0_stage0_iter6 = (dualInfeasConstr_SVfifo_i_full_n == 1'b0);
end
...
assign bitcast_ln162_1_fu_261_p1 = trunc_ln162_s_fu_187_p4;

assign bitcast_ln162_2_fu_265_p1 = trunc_ln162_1_fu_197_p4;

assign bitcast_ln162_3_fu_269_p1 = trunc_ln162_2_fu_207_p4;

assign bitcast_ln162_4_fu_273_p1 = trunc_ln162_3_fu_217_p4;

assign bitcast_ln162_5_fu_277_p1 = trunc_ln162_4_fu_227_p4;

assign bitcast_ln162_6_fu_281_p1 = trunc_ln162_5_fu_237_p4;

assign bitcast_ln162_7_fu_285_p1 = trunc_ln162_6_fu_247_p4;

assign bitcast_ln162_fu_257_p1 = trunc_ln162_fu_183_p1;

assign bitcast_ln168_1_fu_349_p1 = grp_fu_103_p2;

assign bitcast_ln168_2_fu_353_p1 = grp_fu_107_p2;

assign bitcast_ln168_3_fu_357_p1 = grp_fu_111_p2;

assign bitcast_ln168_4_fu_361_p1 = grp_fu_115_p2;

assign bitcast_ln168_5_fu_365_p1 = grp_fu_119_p2;

assign bitcast_ln168_6_fu_369_p1 = grp_fu_123_p2;

assign bitcast_ln168_7_fu_373_p1 = grp_fu_127_p2;

assign bitcast_ln168_fu_345_p1 = grp_fu_99_p2;

assign dualInfeasConstr_SVfifo_i_din = or_ln168_i_fu_377_p9;

assign dualInfeasConstr_SVfifo_i_write = dualInfeasConstr_SVfifo_i_write_local;

assign dualInfeasConstr_fifo_i_read = dualInfeasConstr_fifo_i_read_local;

assign icmp_ln160_fu_157_p2 = (($signed(zext_ln154_fu_153_p1) < $signed(n)) ? 1'b1 : 1'b0);

assign or_ln168_i_fu_377_p9 = {{{{{{{{bitcast_ln168_7_fu_373_p1}, {bitcast_ln168_6_fu_369_p1}}, {bitcast_ln168_5_fu_365_p1}}, {bitcast_ln168_4_fu_361_p1}}, {bitcast_ln168_3_fu_357_p1}}, {bitcast_ln168_2_fu_353_p1}}, {bitcast_ln168_1_fu_349_p1}}, {bitcast_ln168_fu_345_p1}};

assign trunc_ln162_1_fu_197_p4 = {{dualInfeasConstr_fifo_i_dout[191:128]}};

assign trunc_ln162_2_fu_207_p4 = {{dualInfeasConstr_fifo_i_dout[255:192]}};

assign trunc_ln162_3_fu_217_p4 = {{dualInfeasConstr_fifo_i_dout[319:256]}};

assign trunc_ln162_4_fu_227_p4 = {{dualInfeasConstr_fifo_i_dout[383:320]}};

assign trunc_ln162_5_fu_237_p4 = {{dualInfeasConstr_fifo_i_dout[447:384]}};

assign trunc_ln162_6_fu_247_p4 = {{dualInfeasConstr_fifo_i_dout[511:448]}};

assign trunc_ln162_fu_183_p1 = dualInfeasConstr_fifo_i_dout[63:0];

assign trunc_ln162_s_fu_187_p4 = {{dualInfeasConstr_fifo_i_dout[127:64]}};

assign zext_ln154_fu_153_p1 = ap_sig_allocacmp_i_load;

endmodule //Infeasi_Res_S2_scaleVector_Pipeline_scale_vector
