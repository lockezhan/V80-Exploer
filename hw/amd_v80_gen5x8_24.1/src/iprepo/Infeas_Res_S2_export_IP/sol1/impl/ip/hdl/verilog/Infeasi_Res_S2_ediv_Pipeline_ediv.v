...
module Infeasi_Res_S2_ediv_Pipeline_ediv (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        colScale_fifo_ub_dout,
        colScale_fifo_ub_num_data_valid,
        colScale_fifo_ub_fifo_cap,
        colScale_fifo_ub_empty_n,
        colScale_fifo_ub_read,
        temp_ub_din,
...
input  [511:0] colScale_fifo_ub_dout;
input  [2:0] colScale_fifo_ub_num_data_valid;
input  [2:0] colScale_fifo_ub_fifo_cap;
input   colScale_fifo_ub_empty_n;
output   colScale_fifo_ub_read;
output  [511:0] temp_ub_din;
input  [2:0] temp_ub_num_data_valid;
input  [2:0] temp_ub_fifo_cap;
input   temp_ub_full_n;
output   temp_ub_write;
input  [31:0] n_7;
...
wire    colScale_fifo_ub_blk_n;
wire    temp_ub_blk_n;
wire    ap_block_pp0_stage0_11001;
wire   [63:0] trunc_ln418_fu_179_p1;
reg   [63:0] trunc_ln418_reg_528;
reg   [63:0] trunc_ln418_8_reg_533;
reg   [63:0] trunc_ln418_9_reg_538;
reg   [63:0] trunc_ln418_s_reg_543;
reg   [63:0] trunc_ln418_1_reg_548;
reg   [63:0] trunc_ln418_2_reg_553;
reg   [63:0] trunc_ln418_3_reg_558;
reg   [63:0] trunc_ln418_4_reg_563;
wire   [63:0] trunc_ln419_fu_255_p1;
reg   [63:0] trunc_ln419_reg_568;
reg   [63:0] trunc_ln419_8_reg_573;
reg   [63:0] trunc_ln419_9_reg_578;
reg   [63:0] trunc_ln419_s_reg_583;
reg   [63:0] trunc_ln419_1_reg_588;
reg   [63:0] trunc_ln419_2_reg_593;
reg   [63:0] trunc_ln419_3_reg_598;
reg   [63:0] trunc_ln419_4_reg_603;
reg   [30:0] i_fu_68;
wire   [30:0] add_ln416_fu_149_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
reg    primalInfeasBound_edotfifo_ub_read_local;
reg    colScale_fifo_ub_read_local;
wire   [511:0] or_ln426_s_fu_489_p9;
wire    ap_block_pp0_stage0_01001;
reg    temp_ub_write_local;
...
wire   [511:0] pf_temp_ub_U_data_out;
wire    pf_temp_ub_U_data_out_vld;
wire    pf_temp_ub_U_pf_ready;
wire    pf_temp_ub_U_pf_done;
reg   [0:0] ap_frp_data_next_issued_primalInfeasBound_edotfifo_ub;
reg    ap_frp_data_issued_nxt_primalInfeasBound_edotfifo_ub_op83;
reg   [5:0] ap_frp_data_req_primalInfeasBound_edotfifo_ub;
reg   [0:0] ap_frp_data_req_primalInfeasBound_edotfifo_ub_op83;
reg   [0:0] ap_frp_data_next_issued_colScale_fifo_ub;
reg    ap_frp_data_issued_nxt_colScale_fifo_ub_op93;
reg   [5:0] ap_frp_data_req_colScale_fifo_ub;
reg   [0:0] ap_frp_data_req_colScale_fifo_ub_op93;
...
#0 ap_CS_fsm = 1'd1;
#0 i_fu_68 = 31'd0;
#0 ap_frp_data_req_primalInfeasBound_edotfifo_ub = 6'd0;
#0 ap_frp_data_req_colScale_fifo_ub = 6'd0;
#0 pf_all_done = 1'b0;
end
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U566(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_97_p0),
    .din1(grp_fu_97_p1),
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U567(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_101_p0),
    .din1(grp_fu_101_p1),
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U568(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_105_p0),
    .din1(grp_fu_105_p1),
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U569(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_109_p0),
    .din1(grp_fu_109_p1),
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U570(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_113_p0),
    .din1(grp_fu_113_p1),
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U571(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_117_p0),
    .din1(grp_fu_117_p1),
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U572(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_121_p0),
    .din1(grp_fu_121_p1),
...
Infeasi_Res_S2_ddiv_64ns_64ns_64_58_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
ddiv_64ns_64ns_64_58_no_dsp_1_U573(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_125_p0),
    .din1(grp_fu_125_p1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_frp_data_req_colScale_fifo_ub <= 6'd0;
    end else begin
        if ((frp_pipeline_valid_U_valid_out[6'd0] == 1'b0)) begin
            ap_frp_data_req_colScale_fifo_ub <= (ap_frp_data_req_colScale_fifo_ub - ap_frp_data_next_issued_colScale_fifo_ub);
        end else begin
            ap_frp_data_req_colScale_fifo_ub <= ((ap_frp_data_req_colScale_fifo_ub + ap_frp_data_req_colScale_fifo_ub_op93) - ap_frp_data_next_issued_colScale_fifo_ub);
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_frp_data_req_primalInfeasBound_edotfifo_ub <= 6'd0;
    end else begin
        if ((frp_pipeline_valid_U_valid_out[6'd0] == 1'b0)) begin
            ...
            ap_frp_data_req_primalInfeasBound_edotfifo_ub <= ((ap_frp_data_req_primalInfeasBound_edotfifo_ub + ap_frp_data_req_primalInfeasBound_edotfifo_ub_op83) - ap_frp_data_next_issued_primalInfeasBound_edotfifo_ub);
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln418_1_reg_548 <= {{primalInfeasBound_edotfifo_ub_dout[319:256]}};
        trunc_ln418_2_reg_553 <= {{primalInfeasBound_edotfifo_ub_dout[383:320]}};
        trunc_ln418_3_reg_558 <= {{primalInfeasBound_edotfifo_ub_dout[447:384]}};
        trunc_ln418_4_reg_563 <= {{primalInfeasBound_edotfifo_ub_dout[511:448]}};
        trunc_ln418_8_reg_533 <= {{primalInfeasBound_edotfifo_ub_dout[127:64]}};
        trunc_ln418_9_reg_538 <= {{primalInfeasBound_edotfifo_ub_dout[191:128]}};
        trunc_ln418_reg_528 <= trunc_ln418_fu_179_p1;
        trunc_ln418_s_reg_543 <= {{primalInfeasBound_edotfifo_ub_dout[255:192]}};
        trunc_ln419_1_reg_588 <= {{colScale_fifo_ub_dout[319:256]}};
        trunc_ln419_2_reg_593 <= {{colScale_fifo_ub_dout[383:320]}};
        trunc_ln419_3_reg_598 <= {{colScale_fifo_ub_dout[447:384]}};
        trunc_ln419_4_reg_603 <= {{colScale_fifo_ub_dout[511:448]}};
        trunc_ln419_8_reg_573 <= {{colScale_fifo_ub_dout[127:64]}};
        trunc_ln419_9_reg_578 <= {{colScale_fifo_ub_dout[191:128]}};
        trunc_ln419_reg_568 <= trunc_ln419_fu_255_p1;
        trunc_ln419_s_reg_583 <= {{colScale_fifo_ub_dout[255:192]}};
    end
end
...
always @ (*) begin
    if ((frp_pipeline_valid_U_valid_out[6'd1] == 1'b1)) begin
        ap_frp_data_issued_nxt_colScale_fifo_ub_op93 = 1'b1;
    end else begin
        ap_frp_data_issued_nxt_colScale_fifo_ub_op93 = 1'b0;
    end
end

always @ (*) begin
    if ((frp_pipeline_valid_U_valid_out[6'd1] == 1'b1)) begin
        ap_frp_data_issued_nxt_primalInfeasBound_edotfifo_ub_op83 = 1'b1;
    end else begin
        ap_frp_data_issued_nxt_primalInfeasBound_edotfifo_ub_op83 = 1'b0;
    end
end

always @ (*) begin
    if ((ap_frp_data_issued_nxt_colScale_fifo_ub_op93 == 1'b1)) begin
        ap_frp_data_next_issued_colScale_fifo_ub = 1'd1;
    end else begin
        ap_frp_data_next_issued_colScale_fifo_ub = 1'd0;
    end
end

always @ (*) begin
    if ((ap_frp_data_issued_nxt_primalInfeasBound_edotfifo_ub_op83 == 1'b1)) begin
...
always @ (*) begin
    if ((~(icmp_ln416_fu_159_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_frp_data_req_colScale_fifo_ub_op93 = 1'd1;
    end else begin
        ap_frp_data_req_colScale_fifo_ub_op93 = 1'd0;
    end
end

always @ (*) begin
    if ((~(icmp_ln416_fu_159_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_frp_data_req_primalInfeasBound_edotfifo_ub_op83 = 1'd1;
    end else begin
        ap_frp_data_req_primalInfeasBound_edotfifo_ub_op83 = 1'd0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (frp_pipeline_valid_U_valid_out[6'd1] == 1'b1))) begin
        colScale_fifo_ub_read_local = 1'b1;
    end else begin
        colScale_fifo_ub_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if ((pf_temp_ub_U_data_out_vld == 1'b1)) begin
        temp_ub_write = 1'b1;
    end else begin
        temp_ub_write = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter59 == 1'b1))) begin
        temp_ub_write_local = 1'b1;
    end else begin
        temp_ub_write_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_condition_frp_pvb_no_bkwd_prs = (pf_temp_ub_U_pf_ready == 1'b1);
end
...
always @ (*) begin
    ap_condition_frp_roi_pvb_no_fwd_prs = ~((colScale_fifo_ub_num_data_valid < (ap_frp_data_req_colScale_fifo_ub + ap_frp_data_req_colScale_fifo_ub_op93)) | (primalInfeasBound_edotfifo_ub_num_data_valid < (ap_frp_data_req_primalInfeasBound_edotfifo_ub + ap_frp_data_req_primalInfeasBound_edotfifo_ub_op83)));
end
...
assign colScale_fifo_ub_blk_n = 1'b1;

assign colScale_fifo_ub_read = colScale_fifo_ub_read_local;

assign grp_fu_101_p0 = trunc_ln418_8_reg_533;

assign grp_fu_101_p1 = trunc_ln419_8_reg_573;

assign grp_fu_105_p0 = trunc_ln418_9_reg_538;

assign grp_fu_105_p1 = trunc_ln419_9_reg_578;

assign grp_fu_109_p0 = trunc_ln418_s_reg_543;

assign grp_fu_109_p1 = trunc_ln419_s_reg_583;

assign grp_fu_113_p0 = trunc_ln418_1_reg_548;

assign grp_fu_113_p1 = trunc_ln419_1_reg_588;

assign grp_fu_117_p0 = trunc_ln418_2_reg_553;

assign grp_fu_117_p1 = trunc_ln419_2_reg_593;

assign grp_fu_121_p0 = trunc_ln418_3_reg_558;

assign grp_fu_121_p1 = trunc_ln419_3_reg_598;

assign grp_fu_125_p0 = trunc_ln418_4_reg_563;

assign grp_fu_125_p1 = trunc_ln419_4_reg_603;

assign grp_fu_97_p0 = trunc_ln418_reg_528;

assign grp_fu_97_p1 = trunc_ln419_reg_568;

assign icmp_ln416_fu_159_p2 = (($signed(zext_ln413_fu_155_p1) < $signed(n_7)) ? 1'b1 : 1'b0);
...
assign temp_ub_din = pf_temp_ub_U_data_out;

assign trunc_ln418_fu_179_p1 = primalInfeasBound_edotfifo_ub_dout[63:0];

assign trunc_ln419_fu_255_p1 = colScale_fifo_ub_dout[63:0];

assign zext_ln413_fu_155_p1 = ap_sig_allocacmp_i_load;

endmodule //Infeasi_Res_S2_ediv_Pipeline_ediv
