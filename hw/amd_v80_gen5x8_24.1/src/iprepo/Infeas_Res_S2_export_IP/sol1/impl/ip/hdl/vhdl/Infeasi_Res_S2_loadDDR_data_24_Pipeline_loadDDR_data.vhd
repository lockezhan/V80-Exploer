...
entity Infeasi_Res_S2_loadDDR_data_24_Pipeline_loadDDR_data is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Infeasi_Res_S2_loadDDR_data_24_Pipeline_loadDDR_data is 
...
attribute shreg_extract : string;
    ...
    signal add_ln58_fu_103_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal rowScale_fifo_write_local : STD_LOGIC;
    signal zext_ln58_fu_109_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln58_fu_113_p2 = ap_const_lv1_1))) then 
    ...
    add_ln58_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv31_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem8_RVALID, rowScale_fifo_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((rowScale_fifo_full_n = ap_const_logic_0) or (m_axi_gmem8_RVALID = ap_const_logic_0));
    end process;
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln58_fu_113_p2 = ap_const_lv1_0))) then 
    ...
    icmp_ln58_fu_113_p2 <= "1" when (signed(zext_ln58_fu_109_p1) < signed(len)) else "0";
    ...
    rowScale_fifo_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, rowScale_fifo_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    rowScale_fifo_din <= m_axi_gmem8_RDATA;
    rowScale_fifo_write <= rowScale_fifo_write_local;

    rowScale_fifo_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            rowScale_fifo_write_local <= ap_const_logic_1;
        else 
            rowScale_fifo_write_local <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln58_fu_109_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),32));
end behav;
