...
module Infeasi_Res_S2_loadDDR_data_19_Pipeline_loadDDR_data (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    primalINfeasConstr_fifo_i_write_local;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        primalINfeasConstr_fifo_i_write_local = 1'b1;
    end else begin
        primalINfeasConstr_fifo_i_write_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((primalINfeasConstr_fifo_i_full_n == 1'b0) | (m_axi_gmem6_RVALID == 1'b0));
end
...
assign primalINfeasConstr_fifo_i_din = m_axi_gmem6_RDATA;

assign primalINfeasConstr_fifo_i_write = primalINfeasConstr_fifo_i_write_local;

assign zext_ln58_fu_103_p1 = ap_sig_allocacmp_i_load;

endmodule //Infeasi_Res_S2_loadDDR_data_19_Pipeline_loadDDR_data
