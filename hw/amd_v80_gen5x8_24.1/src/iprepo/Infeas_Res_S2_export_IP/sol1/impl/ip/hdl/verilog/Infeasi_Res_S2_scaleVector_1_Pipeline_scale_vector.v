...
module Infeasi_Res_S2_scaleVector_1_Pipeline_scale_vector (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg    primalINfeasConstr_fifo_i_blk_n;
...
reg    primalINfeasConstr_fifo_i_read_local;
wire   [511:0] or_ln168_i_fu_377_p9;
reg    ap_block_pp0_stage0_01001;
reg    primalInfeasConstr_SVfifo_i_write_local;
...
wire   [63:0] trunc_ln162_7_fu_197_p4;
wire   [63:0] trunc_ln162_8_fu_207_p4;
wire   [63:0] trunc_ln162_9_fu_217_p4;
wire   [63:0] trunc_ln162_10_fu_227_p4;
wire   [63:0] trunc_ln162_11_fu_237_p4;
wire   [63:0] trunc_ln162_12_fu_247_p4;
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U295(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_99_p0),
    .din1(grp_fu_99_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U296(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_103_p0),
    .din1(grp_fu_103_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U297(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_107_p0),
    .din1(grp_fu_107_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U298(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_111_p0),
    .din1(grp_fu_111_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U299(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_115_p0),
    .din1(grp_fu_115_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U300(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_119_p0),
    .din1(grp_fu_119_p1),
...
Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_5_med_dsp_1_U302(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_127_p0),
    .din1(grp_fu_127_p1),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        primalINfeasConstr_fifo_i_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        primalINfeasConstr_fifo_i_read_local = 1'b1;
    end else begin
        primalINfeasConstr_fifo_i_read_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter6 == 1'b1))) begin
        primalInfeasConstr_SVfifo_i_write_local = 1'b1;
    end else begin
        primalInfeasConstr_SVfifo_i_write_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (primalINfeasConstr_fifo_i_empty_n == 1'b0);
end

always @ (*) begin
    ap_block_state7_pp0_stage0_iter6 = (primalInfeasConstr_SVfifo_i_full_n == 1'b0);
end
...
assign bitcast_ln162_10_fu_269_p1 = trunc_ln162_8_fu_207_p4;

assign bitcast_ln162_11_fu_273_p1 = trunc_ln162_9_fu_217_p4;

assign bitcast_ln162_12_fu_277_p1 = trunc_ln162_10_fu_227_p4;

assign bitcast_ln162_13_fu_281_p1 = trunc_ln162_11_fu_237_p4;

assign bitcast_ln162_14_fu_285_p1 = trunc_ln162_12_fu_247_p4;

assign bitcast_ln162_8_fu_261_p1 = trunc_ln162_s_fu_187_p4;

assign bitcast_ln162_9_fu_265_p1 = trunc_ln162_7_fu_197_p4;
...
assign primalINfeasConstr_fifo_i_read = primalINfeasConstr_fifo_i_read_local;

assign primalInfeasConstr_SVfifo_i_din = or_ln168_i_fu_377_p9;

assign primalInfeasConstr_SVfifo_i_write = primalInfeasConstr_SVfifo_i_write_local;

assign trunc_ln162_10_fu_227_p4 = {{primalINfeasConstr_fifo_i_dout[383:320]}};

assign trunc_ln162_11_fu_237_p4 = {{primalINfeasConstr_fifo_i_dout[447:384]}};

assign trunc_ln162_12_fu_247_p4 = {{primalINfeasConstr_fifo_i_dout[511:448]}};

assign trunc_ln162_7_fu_197_p4 = {{primalINfeasConstr_fifo_i_dout[191:128]}};

assign trunc_ln162_8_fu_207_p4 = {{primalINfeasConstr_fifo_i_dout[255:192]}};

assign trunc_ln162_9_fu_217_p4 = {{primalINfeasConstr_fifo_i_dout[319:256]}};

assign trunc_ln162_fu_183_p1 = primalINfeasConstr_fifo_i_dout[63:0];

assign trunc_ln162_s_fu_187_p4 = {{primalINfeasConstr_fifo_i_dout[127:64]}};

assign zext_ln154_fu_153_p1 = ap_sig_allocacmp_i_load;

endmodule //Infeasi_Res_S2_scaleVector_1_Pipeline_scale_vector
