...
entity Infeasi_Res_S2_fifo_w512_d3_S_x1 is 
    generic (
...
architecture rtl of Infeasi_Res_S2_fifo_w512_d3_S_x1 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component Infeasi_Res_S2_fifo_w512_d3_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 512;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_Infeasi_Res_S2_fifo_w512_d3_S_x1_ShiftReg : Infeasi_Res_S2_fifo_w512_d3_S_x1_ShiftReg
    generic map (
...
entity Infeasi_Res_S2_fifo_w512_d3_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 512;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Infeasi_Res_S2_fifo_w512_d3_S_x1_ShiftReg;

architecture rtl of Infeasi_Res_S2_fifo_w512_d3_S_x1_ShiftReg is
