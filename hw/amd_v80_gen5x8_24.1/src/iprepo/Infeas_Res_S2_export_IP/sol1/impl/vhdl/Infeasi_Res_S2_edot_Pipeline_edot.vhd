...
entity Infeasi_Res_S2_edot_Pipeline_edot is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    n_5 : IN STD_LOGIC_VECTOR (31 downto 0) );
end;


architecture behav of Infeasi_Res_S2_edot_Pipeline_edot is 
...
attribute shreg_extract : string;
    ...
    signal colScale_fifo_blk_n : STD_LOGIC;
    ...
    signal colScale_fifo_read_local : STD_LOGIC;
    ...
    signal trunc_ln275_1_fu_193_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln275_2_fu_203_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln275_3_fu_213_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln275_4_fu_223_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln275_5_fu_233_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln275_6_fu_243_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_fu_287_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_s_fu_291_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_1_fu_301_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_2_fu_311_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_3_fu_321_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_4_fu_331_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_5_fu_341_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln276_6_fu_351_p4 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ap_frp_data_next_issued_dualInfeasConstr_axpyfifo : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_frp_data_issued_nxt_dualInfeasConstr_axpyfifo_op30 : STD_LOGIC;
    signal ap_frp_data_req_dualInfeasConstr_axpyfifo : STD_LOGIC_VECTOR (2 downto 0) := "000";
    signal ap_frp_data_req_dualInfeasConstr_axpyfifo_op30 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_frp_data_next_issued_colScale_fifo : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_frp_data_issued_nxt_colScale_fifo_op48 : STD_LOGIC;
    signal ap_frp_data_req_colScale_fifo : STD_LOGIC_VECTOR (2 downto 0) := "000";
    signal ap_frp_data_req_colScale_fifo_op48 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    dmul_64ns_64ns_64_5_med_dsp_1_U155 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    dmul_64ns_64ns_64_5_med_dsp_1_U156 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    dmul_64ns_64ns_64_5_med_dsp_1_U157 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    dmul_64ns_64ns_64_5_med_dsp_1_U158 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    dmul_64ns_64ns_64_5_med_dsp_1_U159 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    dmul_64ns_64ns_64_5_med_dsp_1_U160 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    dmul_64ns_64ns_64_5_med_dsp_1_U161 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    dmul_64ns_64ns_64_5_med_dsp_1_U162 : component Infeasi_Res_S2_dmul_64ns_64ns_64_5_med_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    ap_frp_data_req_colScale_fifo_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_frp_data_req_colScale_fifo <= ap_const_lv3_0;
            else
                if ((frp_pipeline_valid_U_valid_out(0) = ap_const_logic_0)) then 
                    ap_frp_data_req_colScale_fifo <= std_logic_vector(unsigned(ap_frp_data_req_colScale_fifo) - unsigned(ap_frp_data_next_issued_colScale_fifo));
                else 
                    ap_frp_data_req_colScale_fifo <= std_logic_vector(unsigned(std_logic_vector(unsigned(ap_frp_data_req_colScale_fifo) + unsigned(ap_frp_data_req_colScale_fifo_op48))) - unsigned(ap_frp_data_next_issued_colScale_fifo));
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_frp_data_req_dualInfeasConstr_axpyfifo_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_frp_data_req_dualInfeasConstr_axpyfifo <= ap_const_lv3_0;
            else
                if ((frp_pipeline_valid_U_valid_out(0) = ap_const_logic_0)) then 
                    ap_frp_data_req_dualInfeasConstr_axpyfifo <= std_logic_vector(unsigned(ap_frp_data_req_dualInfeasConstr_axpyfifo) - unsigned(ap_frp_data_next_issued_dualInfeasConstr_axpyfifo));
                else 
                    ap_frp_data_req_dualInfeasConstr_axpyfifo <= std_logic_vector(unsigned(std_logic_vector(unsigned(ap_frp_data_req_dualInfeasConstr_axpyfifo) + unsigned(ap_frp_data_req_dualInfeasConstr_axpyfifo_op30))) - unsigned(ap_frp_data_next_issued_dualInfeasConstr_axpyfifo));
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_condition_frp_roi_pvb_no_fwd_prs_assign_proc : process(dualInfeasConstr_axpyfifo_num_data_valid, colScale_fifo_num_data_valid, ap_frp_data_req_dualInfeasConstr_axpyfifo, ap_frp_data_req_dualInfeasConstr_axpyfifo_op30, ap_frp_data_req_colScale_fifo, ap_frp_data_req_colScale_fifo_op48)
    begin
                ap_condition_frp_roi_pvb_no_fwd_prs <= not(((unsigned(colScale_fifo_num_data_valid) < unsigned(std_logic_vector(unsigned(ap_frp_data_req_colScale_fifo) + unsigned(ap_frp_data_req_colScale_fifo_op48)))) or (unsigned(dualInfeasConstr_axpyfifo_num_data_valid) < unsigned(std_logic_vector(unsigned(ap_frp_data_req_dualInfeasConstr_axpyfifo) + unsigned(ap_frp_data_req_dualInfeasConstr_axpyfifo_op30))))));
    end process;
    ...
    ap_frp_data_issued_nxt_colScale_fifo_op48_assign_proc : process(frp_pipeline_valid_U_valid_out)
    begin
        if ((frp_pipeline_valid_U_valid_out(1) = ap_const_logic_1)) then 
            ap_frp_data_issued_nxt_colScale_fifo_op48 <= ap_const_logic_1;
        else 
            ap_frp_data_issued_nxt_colScale_fifo_op48 <= ap_const_logic_0;
        end if; 
    end process;


    ap_frp_data_issued_nxt_dualInfeasConstr_axpyfifo_op30_assign_proc : process(frp_pipeline_valid_U_valid_out)
    begin
        if ((frp_pipeline_valid_U_valid_out(1) = ap_const_logic_1)) then 
            ap_frp_data_issued_nxt_dualInfeasConstr_axpyfifo_op30 <= ap_const_logic_1;
        else 
            ap_frp_data_issued_nxt_dualInfeasConstr_axpyfifo_op30 <= ap_const_logic_0;
        end if; 
    end process;


    ap_frp_data_next_issued_colScale_fifo_assign_proc : process(ap_frp_data_issued_nxt_colScale_fifo_op48)
    begin
        if ((ap_frp_data_issued_nxt_colScale_fifo_op48 = ap_const_logic_1)) then 
            ap_frp_data_next_issued_colScale_fifo <= ap_const_lv1_1;
        else 
            ap_frp_data_next_issued_colScale_fifo <= ap_const_lv1_0;
        end if; 
    end process;


    ap_frp_data_next_issued_dualInfeasConstr_axpyfifo_assign_proc : process(ap_frp_data_issued_nxt_dualInfeasConstr_axpyfifo_op30)
    begin
        if ((ap_frp_data_issued_nxt_dualInfeasConstr_axpyfifo_op30 = ap_const_logic_1)) then 
            ap_frp_data_next_issued_dualInfeasConstr_axpyfifo <= ap_const_lv1_1;
        else 
            ap_frp_data_next_issued_dualInfeasConstr_axpyfifo <= ap_const_lv1_0;
        end if; 
    end process;


    ap_frp_data_req_colScale_fifo_op48_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln273_fu_159_p2)
    begin
        if ((not((icmp_ln273_fu_159_p2 = ap_const_lv1_0)) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_frp_data_req_colScale_fifo_op48 <= ap_const_lv1_1;
        else 
            ap_frp_data_req_colScale_fifo_op48 <= ap_const_lv1_0;
        end if; 
    end process;


    ap_frp_data_req_dualInfeasConstr_axpyfifo_op30_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln273_fu_159_p2)
    begin
        if ((not((icmp_ln273_fu_159_p2 = ap_const_lv1_0)) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_frp_data_req_dualInfeasConstr_axpyfifo_op30 <= ap_const_lv1_1;
        else 
            ap_frp_data_req_dualInfeasConstr_axpyfifo_op30 <= ap_const_lv1_0;
        end if; 
    end process;
    ...
    bitcast_ln275_1_fu_257_p1 <= trunc_ln275_s_fu_183_p4;
    bitcast_ln275_2_fu_261_p1 <= trunc_ln275_1_fu_193_p4;
    bitcast_ln275_3_fu_265_p1 <= trunc_ln275_2_fu_203_p4;
    bitcast_ln275_4_fu_269_p1 <= trunc_ln275_3_fu_213_p4;
    bitcast_ln275_5_fu_273_p1 <= trunc_ln275_4_fu_223_p4;
    bitcast_ln275_6_fu_277_p1 <= trunc_ln275_5_fu_233_p4;
    bitcast_ln275_7_fu_281_p1 <= trunc_ln275_6_fu_243_p4;
    bitcast_ln275_fu_253_p1 <= trunc_ln275_fu_179_p1;
    bitcast_ln276_1_fu_365_p1 <= trunc_ln276_s_fu_291_p4;
    bitcast_ln276_2_fu_369_p1 <= trunc_ln276_1_fu_301_p4;
    bitcast_ln276_3_fu_373_p1 <= trunc_ln276_2_fu_311_p4;
    bitcast_ln276_4_fu_377_p1 <= trunc_ln276_3_fu_321_p4;
    bitcast_ln276_5_fu_381_p1 <= trunc_ln276_4_fu_331_p4;
    bitcast_ln276_6_fu_385_p1 <= trunc_ln276_5_fu_341_p4;
    bitcast_ln276_7_fu_389_p1 <= trunc_ln276_6_fu_351_p4;
    ...
    colScale_fifo_blk_n <= ap_const_logic_1;
    colScale_fifo_read <= colScale_fifo_read_local;

    colScale_fifo_read_local_assign_proc : process(ap_block_pp0_stage0_11001, frp_pipeline_valid_U_valid_out)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (frp_pipeline_valid_U_valid_out(1) = ap_const_logic_1))) then 
            colScale_fifo_read_local <= ap_const_logic_1;
        else 
            colScale_fifo_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    dualInfeasConstr_axpyfifo_read_local_assign_proc : process(ap_block_pp0_stage0_11001, frp_pipeline_valid_U_valid_out)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (frp_pipeline_valid_U_valid_out(1) = ap_const_logic_1))) then 
    ...
    icmp_ln273_fu_159_p2 <= "1" when (signed(zext_ln269_fu_155_p1) < signed(n_5)) else "0";
    or_ln282_s_fu_489_p9 <= (((((((bitcast_ln282_7_fu_485_p1 & bitcast_ln282_6_fu_481_p1) & bitcast_ln282_5_fu_477_p1) & bitcast_ln282_4_fu_473_p1) & bitcast_ln282_3_fu_469_p1) & bitcast_ln282_2_fu_465_p1) & bitcast_ln282_1_fu_461_p1) & bitcast_ln282_fu_457_p1);
    ...
    trunc_ln275_1_fu_193_p4 <= dualInfeasConstr_axpyfifo_dout(191 downto 128);
    trunc_ln275_2_fu_203_p4 <= dualInfeasConstr_axpyfifo_dout(255 downto 192);
    trunc_ln275_3_fu_213_p4 <= dualInfeasConstr_axpyfifo_dout(319 downto 256);
    trunc_ln275_4_fu_223_p4 <= dualInfeasConstr_axpyfifo_dout(383 downto 320);
    trunc_ln275_5_fu_233_p4 <= dualInfeasConstr_axpyfifo_dout(447 downto 384);
    trunc_ln275_6_fu_243_p4 <= dualInfeasConstr_axpyfifo_dout(511 downto 448);
    trunc_ln275_fu_179_p1 <= dualInfeasConstr_axpyfifo_dout(64 - 1 downto 0);
    trunc_ln275_s_fu_183_p4 <= dualInfeasConstr_axpyfifo_dout(127 downto 64);
    trunc_ln276_1_fu_301_p4 <= colScale_fifo_dout(191 downto 128);
    trunc_ln276_2_fu_311_p4 <= colScale_fifo_dout(255 downto 192);
    trunc_ln276_3_fu_321_p4 <= colScale_fifo_dout(319 downto 256);
    trunc_ln276_4_fu_331_p4 <= colScale_fifo_dout(383 downto 320);
    trunc_ln276_5_fu_341_p4 <= colScale_fifo_dout(447 downto 384);
    trunc_ln276_6_fu_351_p4 <= colScale_fifo_dout(511 downto 448);
    trunc_ln276_fu_287_p1 <= colScale_fifo_dout(64 - 1 downto 0);
    trunc_ln276_s_fu_291_p4 <= colScale_fifo_dout(127 downto 64);
