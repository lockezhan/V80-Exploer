...
entity Infeasi_Res_S2_loadDDR_data_Pipeline_loadDDR_data is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Infeasi_Res_S2_loadDDR_data_Pipeline_loadDDR_data is 
...
attribute shreg_extract : string;
    ...
    signal dualInfeasRay_fifo_i_write_local : STD_LOGIC;
...
begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem0_RVALID, dualInfeasRay_fifo_i_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((dualInfeasRay_fifo_i_full_n = ap_const_logic_0) or (m_axi_gmem0_RVALID = ap_const_logic_0));
    end process;
    ...
    dualInfeasRay_fifo_i_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, dualInfeasRay_fifo_i_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            dualInfeasRay_fifo_i_blk_n <= dualInfeasRay_fifo_i_full_n;
        else 
            dualInfeasRay_fifo_i_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    dualInfeasRay_fifo_i_din <= m_axi_gmem0_RDATA;
    dualInfeasRay_fifo_i_write <= dualInfeasRay_fifo_i_write_local;

    dualInfeasRay_fifo_i_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            dualInfeasRay_fifo_i_write_local <= ap_const_logic_1;
        else 
            dualInfeasRay_fifo_i_write_local <= ap_const_logic_0;
        end if; 
    end process;
