...
entity Infeasi_Res_S2_loadDDR_data_special_Pipeline_loadDDR_data is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Infeasi_Res_S2_loadDDR_data_special_Pipeline_loadDDR_data is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln73_fu_123_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln73_fu_113_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal colScale_fifo_lb_write_local : STD_LOGIC;
    signal colScale_fifo_ub_write_local : STD_LOGIC;
    signal zext_ln73_fu_119_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln73_fu_123_p2 = ap_const_lv1_1))) then 
    ...
    add_ln73_fu_113_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv31_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem7_RVALID, colScale_fifo_lb_full_n, colScale_fifo_ub_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((colScale_fifo_ub_full_n = ap_const_logic_0) or (colScale_fifo_lb_full_n = ap_const_logic_0) or (m_axi_gmem7_RVALID = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln73_fu_123_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln73_fu_123_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    colScale_fifo_lb_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, colScale_fifo_lb_full_n, ap_block_pp0_stage0)
    begin
    ...
    colScale_fifo_lb_din <= m_axi_gmem7_RDATA;
    colScale_fifo_lb_write <= colScale_fifo_lb_write_local;

    colScale_fifo_lb_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            colScale_fifo_lb_write_local <= ap_const_logic_1;
        else 
            colScale_fifo_lb_write_local <= ap_const_logic_0;
        end if; 
    end process;


    colScale_fifo_ub_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, colScale_fifo_ub_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    colScale_fifo_ub_din <= m_axi_gmem7_RDATA;
    colScale_fifo_ub_write <= colScale_fifo_ub_write_local;

    colScale_fifo_ub_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            colScale_fifo_ub_write_local <= ap_const_logic_1;
        else 
            colScale_fifo_ub_write_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    icmp_ln73_fu_123_p2 <= "1" when (signed(zext_ln73_fu_119_p1) < signed(n)) else "0";
    ...
    zext_ln73_fu_119_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),32));
end behav;
