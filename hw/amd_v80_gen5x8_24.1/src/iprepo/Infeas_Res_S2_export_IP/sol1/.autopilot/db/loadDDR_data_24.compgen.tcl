...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { rowScale_fifo_din { O 512 vector } rowScale_fifo_num_data_valid { I 3 vector } rowScale_fifo_fifo_cap { I 3 vector } rowScale_fifo_full_n { I 1 bit } rowScale_fifo_write { O 1 bit } } \
} "
}
