...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dualInfeasRay_fifo_i_din { O 512 vector } dualInfeasRay_fifo_i_num_data_valid { I 3 vector } dualInfeasRay_fifo_i_fifo_cap { I 3 vector } dualInfeasRay_fifo_i_full_n { I 1 bit } dualInfeasRay_fifo_i_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 18 \
    name nRows_assign_c1 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_nRows_assign_c1 \
    op interface \
    ports { nRows_assign_c1_din { O 32 vector } nRows_assign_c1_num_data_valid { I 3 vector } nRows_assign_c1_fifo_cap { I 3 vector } nRows_assign_c1_full_n { I 1 bit } nRows_assign_c1_write { O 1 bit } } \
} "
}
