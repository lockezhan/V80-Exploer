set moduleName loadDDR_data_18_Pipeline_loadDDR_data
set isTopModule 0
...
set C_modelName {loadDDR_data.18_Pipeline_loadDDR_data}
...
set portList { 
	...
	{ m_axi_gmem5_RFIFONUM sc_in sc_lv 13 signal 1 } 
	...
	{ primalInfeasRay_fifo_i_din sc_out sc_lv 512 signal 3 } 
	{ primalInfeasRay_fifo_i_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ primalInfeasRay_fifo_i_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ primalInfeasRay_fifo_i_full_n sc_in sc_logic 1 signal 3 } 
	{ primalInfeasRay_fifo_i_write sc_out sc_logic 1 signal 3 } 
