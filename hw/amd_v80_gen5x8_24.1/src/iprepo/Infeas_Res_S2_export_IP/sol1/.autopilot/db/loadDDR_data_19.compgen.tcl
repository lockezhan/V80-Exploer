...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { primalINfeasConstr_fifo_i_din { O 512 vector } primalINfeasConstr_fifo_i_num_data_valid { I 3 vector } primalINfeasConstr_fifo_i_fifo_cap { I 3 vector } primalINfeasConstr_fifo_i_full_n { I 1 bit } primalINfeasConstr_fifo_i_write { O 1 bit } } \
} "
}
