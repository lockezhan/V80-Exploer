...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dualInfeasConstr_fifo_i_din { O 512 vector } dualInfeasConstr_fifo_i_num_data_valid { I 3 vector } dualInfeasConstr_fifo_i_fifo_cap { I 3 vector } dualInfeasConstr_fifo_i_full_n { I 1 bit } dualInfeasConstr_fifo_i_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 45 \
    name nCols_assign_c2 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_nCols_assign_c2 \
    op interface \
    ports { nCols_assign_c2_din { O 32 vector } nCols_assign_c2_num_data_valid { I 3 vector } nCols_assign_c2_fifo_cap { I 3 vector } nCols_assign_c2_full_n { I 1 bit } nCols_assign_c2_write { O 1 bit } } \
} "
}
