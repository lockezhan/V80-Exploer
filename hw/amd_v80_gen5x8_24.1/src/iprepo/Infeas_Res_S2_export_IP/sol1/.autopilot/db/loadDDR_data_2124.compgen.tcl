...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { hasUpper_fifo_i_din { O 512 vector } hasUpper_fifo_i_num_data_valid { I 3 vector } hasUpper_fifo_i_fifo_cap { I 3 vector } hasUpper_fifo_i_full_n { I 1 bit } hasUpper_fifo_i_write { O 1 bit } } \
} "
}
...
set InstName Infeasi_Res_S2_flow_control_loop_pipe_U
set CompName Infeasi_Res_S2_flow_control_loop_pipe
