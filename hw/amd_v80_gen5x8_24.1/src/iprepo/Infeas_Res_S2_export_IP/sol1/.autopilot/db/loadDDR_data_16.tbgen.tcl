set moduleName loadDDR_data_16
set isTopModule 0
...
set C_modelName {loadDDR_data.16}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem2 int 512 regular {axi_master 0}  }
	{ dSlackNeg int 64 regular  }
	{ dualInfeasUbRay_fifo_i int 512 regular {fifo 1 volatile }  }
	{ p_read int 32 regular  }
	{ nCols_assign_c3 int 32 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "dSlackNeg","offset": { "type": "dynamic","port_name": "dSlackNeg","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "dualInfeasUbRay_fifo_i", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "nCols_assign_c3", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem2_RFIFONUM sc_in sc_lv 13 signal 0 } 
	...
	{ dSlackNeg sc_in sc_lv 64 signal 1 } 
	{ dualInfeasUbRay_fifo_i_din sc_out sc_lv 512 signal 2 } 
	{ dualInfeasUbRay_fifo_i_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ dualInfeasUbRay_fifo_i_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ dualInfeasUbRay_fifo_i_full_n sc_in sc_logic 1 signal 2 } 
	{ dualInfeasUbRay_fifo_i_write sc_out sc_logic 1 signal 2 } 
	{ p_read sc_in sc_lv 32 signal 3 } 
	{ nCols_assign_c3_din sc_out sc_lv 32 signal 4 } 
	{ nCols_assign_c3_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ nCols_assign_c3_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ nCols_assign_c3_full_n sc_in sc_logic 1 signal 4 } 
	{ nCols_assign_c3_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dualInfeasUbRay_fifo_i_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "dualInfeasUbRay_fifo_i", "role": "din" }} , 
 	...
 	{ "name": "dualInfeasUbRay_fifo_i_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dualInfeasUbRay_fifo_i", "role": "full_n" }} , 
 	{ "name": "dualInfeasUbRay_fifo_i_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dualInfeasUbRay_fifo_i", "role": "write" }} , 
 	{ "name": "p_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_read", "role": "default" }} , 
 	{ "name": "nCols_assign_c3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "nCols_assign_c3", "role": "din" }} , 
 	{ "name": "nCols_assign_c3_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "nCols_assign_c3", "role": "num_data_valid" }} , 
 	{ "name": "nCols_assign_c3_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "nCols_assign_c3", "role": "fifo_cap" }} , 
 	{ "name": "nCols_assign_c3_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nCols_assign_c3", "role": "full_n" }} , 
 	{ "name": "nCols_assign_c3_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nCols_assign_c3", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_loadDDR_data_16_Pipeline_loadDDR_data_fu_84", "Port" : "gmem2", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
			{"Name" : "dSlackNeg", "Type" : "None", "Direction" : "I"},
			{"Name" : "dualInfeasUbRay_fifo_i", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_loadDDR_data_16_Pipeline_loadDDR_data_fu_84", "Port" : "dualInfeasUbRay_fifo_i", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "nCols_assign_c3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "nCols_assign_c3_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_loadDDR_data_16_Pipeline_loadDDR_data_fu_84", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_loadDDR_data_16_Pipeline_loadDDR_data_fu_84.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	dSlackNeg { ap_none {  { dSlackNeg in_data 0 64 } } }
	dualInfeasUbRay_fifo_i { ap_fifo {  { dualInfeasUbRay_fifo_i_din fifo_data_in 1 512 }  { dualInfeasUbRay_fifo_i_num_data_valid fifo_status_num_data_valid 0 3 }  { dualInfeasUbRay_fifo_i_fifo_cap fifo_update 0 3 }  { dualInfeasUbRay_fifo_i_full_n fifo_status 0 1 }  { dualInfeasUbRay_fifo_i_write fifo_port_we 1 1 } } }
	p_read { ap_none {  { p_read in_data 0 32 } } }
	nCols_assign_c3 { ap_fifo {  { nCols_assign_c3_din fifo_data_in 1 32 }  { nCols_assign_c3_num_data_valid fifo_status_num_data_valid 0 3 }  { nCols_assign_c3_fifo_cap fifo_update 0 3 }  { nCols_assign_c3_full_n fifo_status 0 1 }  { nCols_assign_c3_write fifo_port_we 1 1 } } }
}
