...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { primalInfeasRay_fifo_i_din { O 512 vector } primalInfeasRay_fifo_i_num_data_valid { I 3 vector } primalInfeasRay_fifo_i_fifo_cap { I 3 vector } primalInfeasRay_fifo_i_full_n { I 1 bit } primalInfeasRay_fifo_i_write { O 1 bit } } \
} "
}
