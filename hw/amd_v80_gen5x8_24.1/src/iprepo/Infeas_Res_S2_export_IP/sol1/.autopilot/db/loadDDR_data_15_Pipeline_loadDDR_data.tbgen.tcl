set moduleName loadDDR_data_15_Pipeline_loadDDR_data
set isTopModule 0
...
set C_modelName {loadDDR_data.15_Pipeline_loadDDR_data}
...
set portList { 
	...
	{ m_axi_gmem1_RFIFONUM sc_in sc_lv 13 signal 1 } 
	...
	{ dualInfeasLbRay_fifo_i_din sc_out sc_lv 512 signal 3 } 
	{ dualInfeasLbRay_fifo_i_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ dualInfeasLbRay_fifo_i_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ dualInfeasLbRay_fifo_i_full_n sc_in sc_logic 1 signal 3 } 
	{ dualInfeasLbRay_fifo_i_write sc_out sc_logic 1 signal 3 } 
