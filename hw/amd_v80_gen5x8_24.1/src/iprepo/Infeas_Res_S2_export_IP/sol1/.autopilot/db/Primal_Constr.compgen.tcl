...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Infeasi_Res_S2_fifo_w512_d3_S_x1 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {primalInfeasBound_fifo_i_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { primalInfeasConstr_SVfifo_i_dout { I 512 vector } primalInfeasConstr_SVfifo_i_empty_n { I 1 bit } primalInfeasConstr_SVfifo_i_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { pConstrResSq_i { O 64 vector } pConstrResSq_i_ap_vld { O 1 bit } } \
} "
}
