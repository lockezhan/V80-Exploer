...
set C_modelName {scaleVector.12}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ inverse_dScale double 64 regular {fifo 0}  }
	{ dualInfeasRay_fifo_i int 512 regular {fifo 0 volatile }  }
	{ dualInfeasRay_SVfifo_i int 512 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inverse_dScale", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "dualInfeasRay_fifo_i", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "dualInfeasRay_SVfifo_i", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ dualInfeasRay_fifo_i_dout sc_in sc_lv 512 signal 1 } 
	{ dualInfeasRay_fifo_i_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ dualInfeasRay_fifo_i_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ dualInfeasRay_fifo_i_empty_n sc_in sc_logic 1 signal 1 } 
	{ dualInfeasRay_fifo_i_read sc_out sc_logic 1 signal 1 } 
	{ dualInfeasRay_SVfifo_i_din sc_out sc_lv 512 signal 2 } 
	{ dualInfeasRay_SVfifo_i_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ dualInfeasRay_SVfifo_i_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ dualInfeasRay_SVfifo_i_full_n sc_in sc_logic 1 signal 2 } 
	{ dualInfeasRay_SVfifo_i_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dualInfeasRay_fifo_i_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "dualInfeasRay_fifo_i", "role": "dout" }} , 
 	{ "name": "dualInfeasRay_fifo_i_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualInfeasRay_fifo_i", "role": "num_data_valid" }} , 
 	{ "name": "dualInfeasRay_fifo_i_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualInfeasRay_fifo_i", "role": "fifo_cap" }} , 
 	{ "name": "dualInfeasRay_fifo_i_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dualInfeasRay_fifo_i", "role": "empty_n" }} , 
 	{ "name": "dualInfeasRay_fifo_i_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dualInfeasRay_fifo_i", "role": "read" }} , 
 	{ "name": "dualInfeasRay_SVfifo_i_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "dualInfeasRay_SVfifo_i", "role": "din" }} , 
 	{ "name": "dualInfeasRay_SVfifo_i_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualInfeasRay_SVfifo_i", "role": "num_data_valid" }} , 
 	{ "name": "dualInfeasRay_SVfifo_i_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualInfeasRay_SVfifo_i", "role": "fifo_cap" }} , 
 	{ "name": "dualInfeasRay_SVfifo_i_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dualInfeasRay_SVfifo_i", "role": "full_n" }} , 
 	{ "name": "dualInfeasRay_SVfifo_i_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dualInfeasRay_SVfifo_i", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "dualInfeasRay_fifo_i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_scaleVector_12_Pipeline_scale_vector_fu_60", "Port" : "dualInfeasRay_fifo_i", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "dualInfeasRay_SVfifo_i", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_scaleVector_12_Pipeline_scale_vector_fu_60", "Port" : "dualInfeasRay_SVfifo_i", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6", "7", "8", "9", "10"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U46", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U47", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U48", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U49", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U50", "Parent" : "1"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U51", "Parent" : "1"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U52", "Parent" : "1"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.dmul_64ns_64ns_64_5_med_dsp_1_U53", "Parent" : "1"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_scaleVector_12_Pipeline_scale_vector_fu_60.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	dualInfeasRay_fifo_i { ap_fifo {  { dualInfeasRay_fifo_i_dout fifo_data_in 0 512 }  { dualInfeasRay_fifo_i_num_data_valid fifo_status_num_data_valid 0 3 }  { dualInfeasRay_fifo_i_fifo_cap fifo_update 0 3 }  { dualInfeasRay_fifo_i_empty_n fifo_status 0 1 }  { dualInfeasRay_fifo_i_read fifo_port_we 1 1 } } }
	dualInfeasRay_SVfifo_i { ap_fifo {  { dualInfeasRay_SVfifo_i_din fifo_data_in 1 512 }  { dualInfeasRay_SVfifo_i_num_data_valid fifo_status_num_data_valid 0 3 }  { dualInfeasRay_SVfifo_i_fifo_cap fifo_update 0 3 }  { dualInfeasRay_SVfifo_i_full_n fifo_status 0 1 }  { dualInfeasRay_SVfifo_i_write fifo_port_we 1 1 } } }
