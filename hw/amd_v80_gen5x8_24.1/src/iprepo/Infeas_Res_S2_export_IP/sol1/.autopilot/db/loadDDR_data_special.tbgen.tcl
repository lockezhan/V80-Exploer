set moduleName loadDDR_data_special
set isTopModule 0
...
set C_modelName {loadDDR_data_special}
...
set C_modelArgList {
	...
	{ n int 32 regular  }
	{ nCols_c2 int 32 regular {fifo 1}  }
	{ nCols_c3 int 32 regular {fifo 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem7", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "colScale1","offset": { "type": "dynamic","port_name": "colScale1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "nCols_c2", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "nCols_c3", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ colScale_fifo_lb_din sc_out sc_lv 512 signal 2 } 
	{ colScale_fifo_lb_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ colScale_fifo_lb_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ colScale_fifo_lb_full_n sc_in sc_logic 1 signal 2 } 
	{ colScale_fifo_lb_write sc_out sc_logic 1 signal 2 } 
	{ colScale_fifo_ub_din sc_out sc_lv 512 signal 3 } 
	{ colScale_fifo_ub_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ colScale_fifo_ub_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ colScale_fifo_ub_full_n sc_in sc_logic 1 signal 3 } 
	{ colScale_fifo_ub_write sc_out sc_logic 1 signal 3 } 
	{ n sc_in sc_lv 32 signal 4 } 
	{ nCols_c2_din sc_out sc_lv 32 signal 5 } 
	{ nCols_c2_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ nCols_c2_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ nCols_c2_full_n sc_in sc_logic 1 signal 5 } 
	{ nCols_c2_write sc_out sc_logic 1 signal 5 } 
	{ nCols_c3_din sc_out sc_lv 32 signal 6 } 
	{ nCols_c3_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ nCols_c3_fifo_cap sc_in sc_lv 3 signal 6 } 
	{ nCols_c3_full_n sc_in sc_logic 1 signal 6 } 
	{ nCols_c3_write sc_out sc_logic 1 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "nCols_c2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "nCols_c2", "role": "din" }} , 
 	{ "name": "nCols_c2_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "nCols_c2", "role": "num_data_valid" }} , 
 	{ "name": "nCols_c2_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "nCols_c2", "role": "fifo_cap" }} , 
 	{ "name": "nCols_c2_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nCols_c2", "role": "full_n" }} , 
 	{ "name": "nCols_c2_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nCols_c2", "role": "write" }} , 
 	{ "name": "nCols_c3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "nCols_c3", "role": "din" }} , 
 	{ "name": "nCols_c3_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "nCols_c3", "role": "num_data_valid" }} , 
 	{ "name": "nCols_c3_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "nCols_c3", "role": "fifo_cap" }} , 
 	{ "name": "nCols_c3_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nCols_c3", "role": "full_n" }} , 
 	{ "name": "nCols_c3_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nCols_c3", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem7", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_loadDDR_data_special_Pipeline_loadDDR_data_fu_96", "Port" : "gmem7", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
			{"Name" : "mem", "Type" : "None", "Direction" : "I"},
			{"Name" : "colScale_fifo_lb", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_loadDDR_data_special_Pipeline_loadDDR_data_fu_96", "Port" : "colScale_fifo_lb", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
			{"Name" : "colScale_fifo_ub", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_loadDDR_data_special_Pipeline_loadDDR_data_fu_96", "Port" : "colScale_fifo_ub", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
			{"Name" : "n", "Type" : "None", "Direction" : "I"},
			{"Name" : "nCols_c2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "nCols_c2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "nCols_c3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "nCols_c3_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_loadDDR_data_special_Pipeline_loadDDR_data_fu_96", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_loadDDR_data_special_Pipeline_loadDDR_data_fu_96.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	nCols_c2 { ap_fifo {  { nCols_c2_din fifo_data_in 1 32 }  { nCols_c2_num_data_valid fifo_status_num_data_valid 0 3 }  { nCols_c2_fifo_cap fifo_update 0 3 }  { nCols_c2_full_n fifo_status 0 1 }  { nCols_c2_write fifo_port_we 1 1 } } }
	nCols_c3 { ap_fifo {  { nCols_c3_din fifo_data_in 1 32 }  { nCols_c3_num_data_valid fifo_status_num_data_valid 0 3 }  { nCols_c3_fifo_cap fifo_update 0 3 }  { nCols_c3_full_n fifo_status 0 1 }  { nCols_c3_write fifo_port_we 1 1 } } }
}
