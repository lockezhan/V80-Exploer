...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dSlackNeg \
    op interface \
    ports { dSlackNeg { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 34 \
    name dualInfeasUbRay_fifo_i \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_dualInfeasUbRay_fifo_i \
    op interface \
    ports { dualInfeasUbRay_fifo_i_din { O 512 vector } dualInfeasUbRay_fifo_i_num_data_valid { I 3 vector } dualInfeasUbRay_fifo_i_fifo_cap { I 3 vector } dualInfeasUbRay_fifo_i_full_n { I 1 bit } dualInfeasUbRay_fifo_i_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 36 \
    name nCols_assign_c3 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_nCols_assign_c3 \
    op interface \
    ports { nCols_assign_c3_din { O 32 vector } nCols_assign_c3_num_data_valid { I 3 vector } nCols_assign_c3_fifo_cap { I 3 vector } nCols_assign_c3_full_n { I 1 bit } nCols_assign_c3_write { O 1 bit } } \
} "
}
