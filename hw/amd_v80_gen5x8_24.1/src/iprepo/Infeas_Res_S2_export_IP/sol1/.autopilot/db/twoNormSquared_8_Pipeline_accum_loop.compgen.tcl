...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_temp_lb \
    op interface \
    ports { temp_lb_dout { I 512 vector } temp_lb_num_data_valid { I 3 vector } temp_lb_fifo_cap { I 3 vector } temp_lb_empty_n { I 1 bit } temp_lb_read { O 1 bit } } \
} "
}
