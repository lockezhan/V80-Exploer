...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { colScale_fifo_din { O 512 vector } colScale_fifo_num_data_valid { I 3 vector } colScale_fifo_fifo_cap { I 3 vector } colScale_fifo_full_n { I 1 bit } colScale_fifo_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_n_c1 \
    op interface \
    ports { n_c1_din { O 32 vector } n_c1_num_data_valid { I 3 vector } n_c1_fifo_cap { I 3 vector } n_c1_full_n { I 1 bit } n_c1_write { O 1 bit } } \
} "
}
