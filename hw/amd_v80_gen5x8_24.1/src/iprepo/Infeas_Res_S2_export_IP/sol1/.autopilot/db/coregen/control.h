...
#define CONTROL_ADDR_DSLACKPOS_DATA            0x1c
#define CONTROL_BITS_DSLACKPOS_DATA            64
#define CONTROL_ADDR_DSLACKNEG_DATA            0x28
#define CONTROL_BITS_DSLACKNEG_DATA            64
#define CONTROL_ADDR_ATY_DATA                  0x34
#define CONTROL_BITS_ATY_DATA                  64
#define CONTROL_ADDR_COLSCALE0_DATA            0x40
#define CONTROL_BITS_COLSCALE0_DATA            64
#define CONTROL_ADDR_X_DATA                    0x4c
#define CONTROL_BITS_X_DATA                    64
#define CONTROL_ADDR_AX_DATA                   0x58
#define CONTROL_BITS_AX_DATA                   64
#define CONTROL_ADDR_COLSCALE1_DATA            0x64
#define CONTROL_BITS_COLSCALE1_DATA            64
#define CONTROL_ADDR_ROWSCALE_DATA             0x70
#define CONTROL_BITS_ROWSCALE_DATA             64
#define CONTROL_ADDR_HASLOWER_DATA             0x7c
#define CONTROL_BITS_HASLOWER_DATA             64
#define CONTROL_ADDR_HASUPPER_DATA             0x88
#define CONTROL_BITS_HASUPPER_DATA             64
#define CONTROL_ADDR_DPRIMALINFEASRES_VAL_DATA 0x94
#define CONTROL_BITS_DPRIMALINFEASRES_VAL_DATA 64
#define CONTROL_ADDR_DPRIMALINFEASRES_VAL_CTRL 0x9c
#define CONTROL_ADDR_DDUALINFEASRES_VAL_DATA   0xac
#define CONTROL_BITS_DDUALINFEASRES_VAL_DATA   64
#define CONTROL_ADDR_DDUALINFEASRES_VAL_CTRL   0xb4
#define CONTROL_ADDR_NROWS_DATA                0xc4
#define CONTROL_BITS_NROWS_DATA                32
#define CONTROL_ADDR_NCOLS_DATA                0xcc
#define CONTROL_BITS_NCOLS_DATA                32
#define CONTROL_ADDR_PROBLEM_NEQS_DATA         0xd4
#define CONTROL_BITS_PROBLEM_NEQS_DATA         32
#define CONTROL_ADDR_IFSCALED_DATA             0xdc
#define CONTROL_BITS_IFSCALED_DATA             32
#define CONTROL_ADDR_INVERSE_DSCALE_DATA       0xe4
#define CONTROL_BITS_INVERSE_DSCALE_DATA       64
#define CONTROL_ADDR_INVERSE_PSCALE_DATA       0xf0
#define CONTROL_BITS_INVERSE_PSCALE_DATA       64
