set moduleName loadDDR_data_24
set isTopModule 0
...
set C_modelName {loadDDR_data.24}
...
set portList { 
	...
	{ rowScale_fifo_din sc_out sc_lv 512 signal 2 } 
	{ rowScale_fifo_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ rowScale_fifo_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ rowScale_fifo_full_n sc_in sc_logic 1 signal 2 } 
	{ rowScale_fifo_write sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem8", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_loadDDR_data_24_Pipeline_loadDDR_data_fu_84", "Port" : "gmem8", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
			{"Name" : "mem", "Type" : "None", "Direction" : "I"},
			{"Name" : "rowScale_fifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_loadDDR_data_24_Pipeline_loadDDR_data_fu_84", "Port" : "rowScale_fifo", "Inst_start_state" : "13", "Inst_end_state" : "14"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_loadDDR_data_24_Pipeline_loadDDR_data_fu_84", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_loadDDR_data_24_Pipeline_loadDDR_data_fu_84.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
