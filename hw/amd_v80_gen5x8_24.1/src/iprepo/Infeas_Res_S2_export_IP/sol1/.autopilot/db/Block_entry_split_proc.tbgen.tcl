...
set C_modelArgMapList {[ 
	{ "Name" : "nRows", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ nRows sc_in sc_lv 32 signal 0 } 
	{ nCols sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "nRows", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "nRows", "role": "default" }} , 
...
set Spec2ImplPortList { 
	nRows { ap_none {  { nRows in_data 0 32 } } }
	nCols { ap_none {  { nCols in_data 0 32 } } }
}
