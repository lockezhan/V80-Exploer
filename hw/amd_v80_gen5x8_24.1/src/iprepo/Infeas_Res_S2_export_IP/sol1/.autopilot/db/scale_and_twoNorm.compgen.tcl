...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_colScale0 \
    op interface \
    ports { colScale0 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dualInfeasConstr_axpyfifo_i_dout { I 512 vector } dualInfeasConstr_axpyfifo_i_num_data_valid { I 3 vector } dualInfeasConstr_axpyfifo_i_fifo_cap { I 3 vector } dualInfeasConstr_axpyfifo_i_empty_n { I 1 bit } dualInfeasConstr_axpyfifo_i_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dPrimalInfeasRes_din { O 64 vector } dPrimalInfeasRes_num_data_valid { I 3 vector } dPrimalInfeasRes_fifo_cap { I 3 vector } dPrimalInfeasRes_full_n { I 1 bit } dPrimalInfeasRes_write { O 1 bit } } \
} "
}
