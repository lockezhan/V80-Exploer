...
entity Infeasi_Res_S2_Block_entry_split_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Infeasi_Res_S2_Block_entry_split_proc is 
...
begin
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state1, nRows, ap_block_state1, ap_return_0_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_0 <= nRows;
        else 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm_state1, nCols, ap_block_state1, ap_return_1_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_1 <= nCols;
        else 
