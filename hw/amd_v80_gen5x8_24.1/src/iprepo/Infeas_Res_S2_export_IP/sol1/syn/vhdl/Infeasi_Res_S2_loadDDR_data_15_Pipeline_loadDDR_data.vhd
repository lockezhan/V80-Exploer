...
entity Infeasi_Res_S2_loadDDR_data_15_Pipeline_loadDDR_data is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Infeasi_Res_S2_loadDDR_data_15_Pipeline_loadDDR_data is 
...
attribute shreg_extract : string;
    ...
    signal dualInfeasLbRay_fifo_i_write_local : STD_LOGIC;
...
begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem1_RVALID, dualInfeasLbRay_fifo_i_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((dualInfeasLbRay_fifo_i_full_n = ap_const_logic_0) or (m_axi_gmem1_RVALID = ap_const_logic_0));
    end process;
    ...
    dualInfeasLbRay_fifo_i_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, dualInfeasLbRay_fifo_i_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            dualInfeasLbRay_fifo_i_blk_n <= dualInfeasLbRay_fifo_i_full_n;
        else 
            dualInfeasLbRay_fifo_i_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    dualInfeasLbRay_fifo_i_din <= m_axi_gmem1_RDATA;
    dualInfeasLbRay_fifo_i_write <= dualInfeasLbRay_fifo_i_write_local;

    dualInfeasLbRay_fifo_i_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            dualInfeasLbRay_fifo_i_write_local <= ap_const_logic_1;
        else 
            dualInfeasLbRay_fifo_i_write_local <= ap_const_logic_0;
        end if; 
    end process;
