...
module Infeasi_Res_S2_twoNorm_23 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] n_3_reg_97;
reg    ap_block_state1;
wire    grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start;
wire    grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_done;
wire    grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_idle;
wire    grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_ready;
wire    grp_twoNorm_23_Pipeline_twoNorm_fu_55_temp_read;
wire   [63:0] grp_twoNorm_23_Pipeline_twoNorm_fu_55_nrm_out;
wire    grp_twoNorm_23_Pipeline_twoNorm_fu_55_nrm_out_ap_vld;
reg    grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start_reg;
wire    ap_CS_fsm_state2;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
reg    n_read_local;
wire   [63:0] bitcast_ln262_fu_81_p1;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 59'd1;
#0 grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start_reg = 1'b0;
end

Infeasi_Res_S2_twoNorm_23_Pipeline_twoNorm grp_twoNorm_23_Pipeline_twoNorm_fu_55(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Infeasi_Res_S2_dsqrt_64ns_64ns_64_56_no_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dsqrt_64ns_64ns_64_56_no_dsp_1_U180(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(64'd0),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start_reg <= 1'b1;
        end else if ((grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_ready == 1'b1)) begin
            grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_done == 1'b1))) begin
...
assign bitcast_ln262_fu_81_p1 = grp_fu_63_p2;

assign dPrimalInfeasRes_din = bitcast_ln262_fu_81_p1;

assign dPrimalInfeasRes_write = dPrimalInfeasRes_write_local;

assign grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start = grp_twoNorm_23_Pipeline_twoNorm_fu_55_ap_start_reg;

assign n_read = n_read_local;

endmodule //Infeasi_Res_S2_twoNorm_23
