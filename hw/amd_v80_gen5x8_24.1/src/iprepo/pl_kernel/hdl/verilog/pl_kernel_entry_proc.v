...
output   start_write;
input  [63:0] xUpdate;
output  [63:0] xUpdate_c_din;
input  [2:0] xUpdate_c_num_data_valid;
input  [2:0] xUpdate_c_fifo_cap;
input   xUpdate_c_full_n;
output   xUpdate_c_write;
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        xUpdate_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        xUpdate_c_write_local = 1'b1;
    end else begin
        xUpdate_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (len_assign_loc_empty_n == 1'b0) | (xUpdate_c_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign xUpdate_c_din = xUpdate;

assign xUpdate_c_write = xUpdate_c_write_local;

endmodule //pl_kernel_entry_proc
