...
module pl_kernel_read_3_Pipeline_VITIS_LOOP_13_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [29:0] i_fu_52;
wire   [29:0] add_ln13_fu_117_p2;
wire    ap_loop_init;
reg   [29:0] ap_sig_allocacmp_i_load;
reg    ap_block_pp0_stage0_01001;
reg    lb_s_i_write_local;
wire   [30:0] zext_ln13_fu_107_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln13_fu_111_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln13_fu_111_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        lb_s_i_write_local = 1'b1;
    end else begin
        lb_s_i_write_local = 1'b0;
    end
end
...
assign add_ln13_fu_117_p2 = (ap_sig_allocacmp_i_load + 30'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((lb_s_i_full_n == 1'b0) | (m_axi_gmem4_RVALID == 1'b0));
end
...
assign icmp_ln13_fu_111_p2 = (($signed(zext_ln13_fu_107_p1) < $signed(p_read)) ? 1'b1 : 1'b0);

assign lb_s_i_din = m_axi_gmem4_RDATA;

assign lb_s_i_write = lb_s_i_write_local;
...
assign zext_ln13_fu_107_p1 = ap_sig_allocacmp_i_load;

endmodule //pl_kernel_read_3_Pipeline_VITIS_LOOP_13_1
