...
architecture behav of pl_kernel_read_4 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln13_1_reg_231 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter11_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state13_pp0_stage0_iter12 : BOOLEAN;
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal icmp_ln13_1_fu_161_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ub_read_reg_221 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln13_fu_135_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln13_reg_226 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter7_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter8_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter9_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln13_1_reg_231_pp0_iter10_reg : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_256)) then
                if ((icmp_ln13_1_fu_161_p2 = ap_const_lv1_1)) then 
    ...
    ap_block_state13_pp0_stage0_iter12_assign_proc : process(m_axi_gmem5_RVALID, icmp_ln13_1_reg_231_pp0_iter11_reg, ub_s_i_full_n)
    begin
                ap_block_state13_pp0_stage0_iter12 <= (((ub_s_i_full_n = ap_const_logic_0) and (icmp_ln13_1_reg_231_pp0_iter11_reg = ap_const_lv1_1)) or ((icmp_ln13_1_reg_231_pp0_iter11_reg = ap_const_lv1_1) and (m_axi_gmem5_RVALID = ap_const_logic_0)));
    end process;
    ...
    ap_block_state2_io_assign_proc : process(m_axi_gmem5_ARREADY, first_iter_0_reg_101)
    begin
                ap_block_state2_io <= ((m_axi_gmem5_ARREADY = ap_const_logic_0) and (first_iter_0_reg_101 = ap_const_lv1_1));
    end process;
    ...
    ap_condition_364_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln13_1_reg_231, ap_block_pp0_stage0_11001)
    begin
                ap_condition_364 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_1_reg_231 = ap_const_lv1_1));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln13_1_fu_161_p2, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln13_1_fu_161_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    empty_55_fu_127_p3 <= 
        ...
        ap_const_lv30_0;
    empty_fu_123_p1 <= p_read(30 - 1 downto 0);

    gmem5_blk_n_AR_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_gmem5_ARREADY, first_iter_0_reg_101, ap_block_pp0_stage0)
    begin
    ...
    gmem5_blk_n_R_assign_proc : process(ap_enable_reg_pp0_iter12, m_axi_gmem5_RVALID, icmp_ln13_1_reg_231_pp0_iter11_reg, ap_block_pp0_stage0)
    begin
        if (((ap_enable_reg_pp0_iter12 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln13_1_reg_231_pp0_iter11_reg = ap_const_lv1_1))) then 
    ...
    icmp_ln13_1_fu_161_p2 <= "1" when (signed(zext_ln11_fu_157_p1) < signed(p_read)) else "0";
    icmp_ln13_fu_117_p2 <= "1" when (signed(p_read) > signed(ap_const_lv31_0)) else "0";
    m_axi_gmem5_ARADDR <= sext_ln13_fu_194_p1;
    m_axi_gmem5_ARBURST <= ap_const_lv2_0;
    m_axi_gmem5_ARCACHE <= ap_const_lv4_0;
    m_axi_gmem5_ARID <= ap_const_lv1_0;
    m_axi_gmem5_ARLEN <= zext_ln13_reg_226(32 - 1 downto 0);
    ...
    m_axi_gmem5_ARVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, first_iter_0_reg_101, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_gmem5_RREADY_assign_proc : process(ap_enable_reg_pp0_iter12, icmp_ln13_1_reg_231_pp0_iter11_reg, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter12 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_1_reg_231_pp0_iter11_reg = ap_const_lv1_1))) then 
    ...
    trunc_ln_fu_185_p4 <= ub_read_reg_221(63 downto 5);

    ub_s_i_blk_n_assign_proc : process(ap_enable_reg_pp0_iter12, icmp_ln13_1_reg_231_pp0_iter11_reg, ub_s_i_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_enable_reg_pp0_iter12 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln13_1_reg_231_pp0_iter11_reg = ap_const_lv1_1))) then 
    ...
    ub_s_i_din <= m_axi_gmem5_RDATA;
    ub_s_i_write <= ub_s_i_write_local;

    ub_s_i_write_local_assign_proc : process(ap_enable_reg_pp0_iter12, icmp_ln13_1_reg_231_pp0_iter11_reg, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter12 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_1_reg_231_pp0_iter11_reg = ap_const_lv1_1))) then 
            ub_s_i_write_local <= ap_const_logic_1;
        else 
            ub_s_i_write_local <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln11_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),31));
    zext_ln13_fu_135_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_55_fu_127_p3),64));
end behav;
