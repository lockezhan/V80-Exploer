...
entity pl_kernel_read_3_Pipeline_VITIS_LOOP_13_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pl_kernel_read_3_Pipeline_VITIS_LOOP_13_1 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln13_fu_117_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal lb_s_i_write_local : STD_LOGIC;
    signal zext_ln13_fu_107_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln13_fu_111_p2 = ap_const_lv1_1))) then 
                    i_fu_52 <= add_ln13_fu_117_p2;
    ...
    add_ln13_fu_117_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv30_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem4_RVALID, lb_s_i_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((lb_s_i_full_n = ap_const_logic_0) or (m_axi_gmem4_RVALID = ap_const_logic_0));
    end process;
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln13_fu_111_p2 = ap_const_lv1_0))) then 
    ...
    icmp_ln13_fu_111_p2 <= "1" when (signed(zext_ln13_fu_107_p1) < signed(p_read)) else "0";

    lb_s_i_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, lb_s_i_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            lb_s_i_blk_n <= lb_s_i_full_n;
        else 
            lb_s_i_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    lb_s_i_din <= m_axi_gmem4_RDATA;
    lb_s_i_write <= lb_s_i_write_local;

    lb_s_i_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            lb_s_i_write_local <= ap_const_logic_1;
        else 
            lb_s_i_write_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    zext_ln13_fu_107_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),31));
end behav;
