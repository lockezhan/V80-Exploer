...
entity pl_kernel_fifo_w31_d2_S_x is 
    generic (
...
architecture rtl of pl_kernel_fifo_w31_d2_S_x is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component pl_kernel_fifo_w31_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 31;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_pl_kernel_fifo_w31_d2_S_x_ShiftReg : pl_kernel_fifo_w31_d2_S_x_ShiftReg
    generic map (
...
entity pl_kernel_fifo_w31_d2_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 31;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end pl_kernel_fifo_w31_d2_S_x_ShiftReg;

architecture rtl of pl_kernel_fifo_w31_d2_S_x_ShiftReg is
