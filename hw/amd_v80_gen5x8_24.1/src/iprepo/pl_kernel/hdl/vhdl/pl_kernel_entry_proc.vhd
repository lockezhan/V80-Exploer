...
entity pl_kernel_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pl_kernel_entry_proc is 
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_0_preg <= len_assign_loc_dout;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_1_preg <= len_assign_loc_dout;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, xUpdate_c_full_n, len_assign_loc_empty_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (len_assign_loc_empty_n = ap_const_logic_0) or (xUpdate_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm_state1, len_assign_loc_dout, ap_block_state1, ap_return_0_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_0 <= len_assign_loc_dout;
        else 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm_state1, len_assign_loc_dout, ap_block_state1, ap_return_1_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_1 <= len_assign_loc_dout;
        else 
    ...
    len_assign_loc_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, len_assign_loc_empty_n)
    begin
    ...
    xUpdate_c_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, xUpdate_c_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            xUpdate_c_blk_n <= xUpdate_c_full_n;
        else 
            xUpdate_c_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    xUpdate_c_din <= xUpdate;
    xUpdate_c_write <= xUpdate_c_write_local;

    xUpdate_c_write_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            xUpdate_c_write_local <= ap_const_logic_1;
        else 
            xUpdate_c_write_local <= ap_const_logic_0;
        end if; 
    end process;
