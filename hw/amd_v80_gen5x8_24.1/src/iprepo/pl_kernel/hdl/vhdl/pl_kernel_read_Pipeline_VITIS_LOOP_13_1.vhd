...
entity pl_kernel_read_Pipeline_VITIS_LOOP_13_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pl_kernel_read_Pipeline_VITIS_LOOP_13_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln13_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_fu_54 : STD_LOGIC_VECTOR (29 downto 0) := "000000000000000000000000000000";
    signal add_ln13_fu_119_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal xin_i_write_local : STD_LOGIC;
    signal zext_ln13_fu_109_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln13_fu_113_p2 = ap_const_lv1_1))) then 
    ...
    add_ln13_fu_119_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv30_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem0_RVALID, xin_i_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((xin_i_full_n = ap_const_logic_0) or (m_axi_gmem0_RVALID = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln13_fu_113_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln13_fu_113_p2 = ap_const_lv1_0))) then 
    ...
    icmp_ln13_fu_113_p2 <= "1" when (signed(zext_ln13_fu_109_p1) < signed(len)) else "0";
    ...
    xin_i_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, xin_i_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    xin_i_din <= m_axi_gmem0_RDATA;
    xin_i_write <= xin_i_write_local;

    xin_i_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            xin_i_write_local <= ap_const_logic_1;
        else 
            xin_i_write_local <= ap_const_logic_0;
        end if; 
    end process;

    zext_ln13_fu_109_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),31));
end behav;
