...
entity pl_kernel_fifo_w64_d4_S is 
    generic (
...
architecture rtl of pl_kernel_fifo_w64_d4_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component pl_kernel_fifo_w64_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_pl_kernel_fifo_w64_d4_S_ShiftReg : pl_kernel_fifo_w64_d4_S_ShiftReg
    generic map (
...
entity pl_kernel_fifo_w64_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end pl_kernel_fifo_w64_d4_S_ShiftReg;

architecture rtl of pl_kernel_fifo_w64_d4_S_ShiftReg is
