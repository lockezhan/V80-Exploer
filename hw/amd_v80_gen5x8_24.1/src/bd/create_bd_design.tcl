...
\
  ...
  # Create port connections
  connect_bd_net -net base_logic_clk_out1 [get_bd_pins base_logic/clk_out1] [get_bd_pins axi_noc_cips/aclk5]
  connect_bd_net -net base_logic_irq_axi_smbus_rpu [get_bd_pins base_logic/irq_axi_smbus_rpu] [get_bd_pins cips/pl_ps_irq1]
